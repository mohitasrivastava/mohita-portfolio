...
import Mohita from './images/Mohita.jpg';
import {
  VerticalTimeline,
        ...
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
            ...
            <div className="hidden md:flex items-center gap-6 ml-6 flex-1">
              ...
              <a
                href="https://1drv.ms/b/s!AlTPDP5lwTeSkKgER1vICwnSClaVUQ?e=6RvXGl"
          ...
          >
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center ">
              <p className="text-lg text-textBase text-center">
                ...
                Dedicated web developer using HTML, CSS, JS, React, NodeJs,
                Python, Django. Proactive individual and can work in the field
                of Embedded system, Web Development, Full Stack Developer
              </p>
